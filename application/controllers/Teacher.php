...
class Teacher extends MY_Controller
{
    ...
    public function teacher_video(){
        ...
        $data = array(     
            'vedio' => $vedio,
            //'use_webcam' => $this->input->post('use_webcam', true),   
        );	
        $user = $this->Student_model->teacher_intro_update($id, $data);
        if($user) {
            redirect($this->agent->referrer());
    ...
    public function teacher_language(){
        ...
        $data = array(     
            ...
            'speak_lang_le' => $this->input->post('speak_lang_le', true),
            'speak_lang_pri' => $this->input->post('speak_lang_pri', true),
            ...
            'optional_lang_le' => $this->input->post('optional_lang_le',true),
        );	
            $user = $this->Student_model->teacher_intro_update($id, $data);
            if($user) {
                redirect($this->agent->referrer());
